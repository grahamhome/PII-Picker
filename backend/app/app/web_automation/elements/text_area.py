"""
Description: Represents an editable text area.
"""
import time

from app.web_automation.elements.fillable_element import FillableElement
from app.web_automation.elements.form_component import FormComponent


class TextArea(FillableElement, FormComponent):
    """
    Represents an editable textarea. Allows fields to be located via different attributes
    e.g. ID or class name.
    """

    def __init__(self, identifier=None, attribute=None, xpath=None, input_type=None):
        """
        Construct a new TextArea instance,
        located using the specified attribute and attribute-value OR a supplied xpath.
        """
        super().__init__(
            element_type="textarea", identifier=identifier, attribute=attribute, xpath=xpath, input_type=input_type,
        )
